...
namespace Services
{
    public static class ServiceExtension
    {
        ...
        //     {
        //         options.UseNpgsql(Configuration.GetConnectionString(ConnectionString), op => op.CommandTimeout(60));
        ...
        public static void AddSwaggerGen(this IServiceCollection services, string Title, string Description, string Version = "v1")
        {
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    {
                        Name = "Abdellah El Bekkali",
                        Email = "abdellah.elbekkali@cloud-digitransform.co"
                    }
                });
